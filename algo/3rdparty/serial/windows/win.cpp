...
Serial::SerialImpl::open ()
{
  ...
  if (fd_ == INVALID_HANDLE_VALUE) {
    ...
    case ERROR_FILE_NOT_FOUND:
      ...
      LOG_F(ERROR, "Specified port,%s,does not exist.", ss.str().c_str());
      return;
    default:
      LOG_F(ERROR, "Unknown error opening the serial port");
      return;
    }
  }
...
{
  port_ = string(port.begin(), port.end());
}
