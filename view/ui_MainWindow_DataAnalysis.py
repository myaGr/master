...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_4.addWidget(self.textBrowser_showmsg2)
        ...
        self.verticalLayout_6.addWidget(self.textBro_PrintMsg2)

        self.botton_help = QtWidgets.QPushButton(self.centralwidget)
        self.botton_help.setObjectName("botton_help")
        self.verticalLayout_6.addWidget(self.botton_help)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_GetRefFile.setPlaceholderText(_translate("MainWindow", "文件名中含设备名，如：\"test_100C.txt\""))
        ...
        self.pushBtn_SelectIns_2.setText(_translate("MainWindow", "+ 添加文件"))
        ...
        self.label_7.setText(_translate("MainWindow", "开始时间（周内秒）："))
        self.lineEdit_StarTime.setPlaceholderText(_translate("MainWindow", "0"))
        self.label_8.setText(_translate("MainWindow", " 结束时间（周内秒）："))
        ...
        self.label_dbc.setText(_translate("MainWindow", "dbc文件* :"))
        self.lineEdit_getDBCtext.setPlaceholderText(_translate("MainWindow", "dbc文件"))
        self.pushBtn_getDBCtext.setText(_translate("MainWindow", "选择文件"))
        self.label_file.setText(_translate("MainWindow", "待解析文件*  ："))
        self.lineEdit_GetFiletext.setToolTip(_translate("MainWindow", "blf/asc文件路径"))
        self.lineEdit_GetFiletext.setPlaceholderText(_translate("MainWindow", "blf/asc文件路径"))
