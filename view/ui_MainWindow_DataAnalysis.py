...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.botton_help = QtWidgets.QPushButton(self.tab_2)
        ...
        self.horizontalLayout_15.addWidget(self.textBro_PrintMsg2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "INS解析与数据分析工具V1.3.3   Powered by 算法部 2022/11/09 "))
        ...
        self.importScene.setText(_translate("MainWindow", "导入场景"))
