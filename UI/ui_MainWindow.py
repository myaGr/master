...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_8.addAction(self.action_1_NMEA)
        self.menu_8.addAction(self.action_CSV_NMEA)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "数据解析分析工具V3.0  Powered by 算法部"))
...
""))
        ...
        self.action_28.setText(_translate("MainWindow", "斯坦福图绘制"))
        self.action_29.setText(_translate("MainWindow", "数据管理窗口"))
        self.action_30.setText(_translate("MainWindow", "日志打印窗口"))
        self.action_31.setText(_translate("MainWindow", "使用说明"))
        self.action_32.setText(_translate("MainWindow", "版本更新"))
